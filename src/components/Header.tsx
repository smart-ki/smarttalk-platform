      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/termine" className="btn-primary text-sm py-2.5 px-6">Kurs buchen</Link>
          </nav>
        ...
        {menuOpen && (
          <div className="md:hidden py-6 border-t border-ink/10">
            <nav className="flex flex-col gap-4">
              ...
              <Link href="/termine" className="btn-primary text-sm text-center py-2.5 px-6" onClick={() => setMenuOpen(false)}>Kurs buchen</Link>
            </nav>
          </div>
        )}
      </div>
